...
| Fluent vs declarative styles          | [Fluent vs Declarative API](/docs/explanations/fluent-vs-declarative) |

---

_Found a problem? [Open an issue](https://github.com/ChipiKaf/vizcraft/issues/new?labels=documentation&title=Docs:+Getting+Started) on GitHub._
