...
export const anchoredPrimitiveBuilder = viz().view(640, 260);
export const anchoredPrimitiveScene = anchoredPrimitiveBuilder
  .node('producer')
  .at(120, 120)
  .rect(110, 72, 16)
  ...
  .at(520, 120)
  .cylinder(120, 64)
  .label('Store', { dy: -48, fontWeight: 700 })
  .overlay((o) =>
    o
      .circle(
        {
...
export const coloredSignalBuilder = viz().view(520, 200);
export const coloredSignalScene = coloredSignalBuilder
  .node('primary')
  .at(120, 100)
  .circle(18)
  .label('Primary')
  ...
  .circle(18)
  .label('Reader')
  .edge('primary', 'reader', 'primary-reader')
  .routing('curved')
  .via(260, 180)
  .stroke('#334155', 3)
  .overlay((o) =>
      ...
      .text(
        {
          x: 24,
          y: 28,
          text: 'Green = committed, amber = stale',
          fontSize: 14,
        },
        { key: 'legend' }
      )
...
`}>
  ...
  <VizMount builder={anchoredPrimitiveScene} />
</CodePreview>
...
`}>
  ...
  <VizMount builder={coloredSignalScene} />
</CodePreview>
