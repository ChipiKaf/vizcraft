...
export const lbScene = fromSpec({
  ...
  nodes: [
    { id: 'client', label: 'Client',        x: 80,  y: 130, width: 100, height: 38, fill: '#0e7490', stroke: '#164e63' },
    { id: 'lb',     label: 'Load Balancer', x: 320, y: 130, width: 140, height: 38, fill: '#7c3aed', stroke: '#5b21b6' },
    { id: 's1',     label: 'Server 1',      x: 560, y: 70,  width: 100, height: 38, shape: 'cylinder', fill: '#065f46', stroke: '#047857' },
    { id: 's2',     label: 'Server 2',      x: 560, y: 190, width: 100, height: 38, shape: 'cylinder', fill: '#065f46', stroke: '#047857' },
  ],
  edges: [
    { from: 'client', to: 'lb' },
    { from: 'lb',     to: 's1' },
...
export const overlayScene = fromSpec({
  ...
  nodes: [
    { id: 'a', label: 'Cache',  x: 160, y: 90, fill: '#22c55e', stroke: '#15803d' },
    { id: 'b', label: 'Worker', x: 480, y: 90, fill: '#3b82f6', stroke: '#1d4ed8' },
  ],
...
const builder = fromSpec(spec)
  .node('extra').at(900, 180).rect(120, 40).label('Extra').done()
  .edge('lb', 'extra').done();
