...
export const equidistantPortsScene = (() => {
  ...
  const db = b.node('db').at(300, 175).cylinder(120, 80).label('Database').fill('#DBEAFE').stroke('#1D4ED8', 2);
...
*Found a problem? [Open an issue](https://github.com/ChipiKaf/vizcraft/issues/new?labels=documentation&title=Docs:+Advanced) on GitHub.*
