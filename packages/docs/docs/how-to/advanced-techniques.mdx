...
export const straightLineScene = (() => {
  ...
  // Fixed angles (90°→270° = bottom→top) — skewed when nodes aren't aligned
  b.node('a1')
    .at(80, 60)
    .rect(70, 40, 6)
    .fill('#fca5a5')
  ...
  b.edge('a1', 'b1')
    ...
    .arrow()
    .stroke('#dc2626')
    .label('fromAngle(90)', { dy: -8 });
  // .straightLine() — same layout, auto-computed angles
  b.node('a2')
    .at(330, 60)
    .rect(70, 40, 6)
    .fill('#86efac')
...
`}>
  ...
  <VizMount builder={straightLineScene} style={{ height: '260px', width: '100%' }} />
</CodePreview>
