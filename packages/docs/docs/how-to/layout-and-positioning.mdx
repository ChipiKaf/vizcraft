...
`getNodeBoundingBox` handles every `NodeShape` variant — circles, rects, diamonds, stars, hexagons, and all others — so your layout code stays correct as VizCraft adds new shapes.

---

_Found a problem? [Open an issue](https://github.com/ChipiKaf/vizcraft/issues/new?labels=documentation&title=Docs:+Layout) on GitHub._
