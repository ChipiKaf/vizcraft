...
- [`0915f14`](https://github.com/ChipiKaf/vizcraft/commit/0915f14590c1da7a3c6508c52bd9c842b04a9d08) Thanks [@ChipiKaf](https://github.com/ChipiKaf)! - Add structural and semantic diagramming to the declarative spec (`fromSpec`): container groups, zones, auto-layout, edge ports & smart routing, semantic kinds, legends/titles/notes, collapse/expand, focus, and container-aware signals.
...
- [`1ccb638`](https://github.com/ChipiKaf/vizcraft/commit/1ccb638ca865461af41fb9375e5b0ac347915b25) Thanks [@ChipiKaf](https://github.com/ChipiKaf)! - Add `padding` and `className` to `EntryOptions` for per-entry vertical spacing and custom CSS targeting. Padding accepts a uniform number or `{ top, bottom }` and increases entry height while keeping text vertically centered. `className` is appended to the entry element's internal class string.
